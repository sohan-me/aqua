...
interface TargetBiomassResult {
  ...
  growth_calculation_method: string;
  days_to_target: number;
  target_date: string;
  feed_conversion_ratio: number;
  fcr_calculation_method: string;
  total_feed_required_kg: number;
  daily_feed_kg: number;
  feeding_rate_percent: number;
  feeding_frequency: number;
  feeding_analysis: Record<string, unknown>;
  pond_name: string;
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Calculate feeding requirements and timeline to reach your target biomass using CustomerStock data</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Calculated from CustomerStock data in the selected pond</p>
            </div>
            ...
            {form.pondId && form.itemId && result && (
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">Calculated from CustomerStock data ({result.data_source})</p>
              </div>
            )}
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold text-orange-600">
                        {result.total_feed_required_kg.toFixed(1)} kg
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium text-gray-500">Fish Item</label>
                      <p className="text-lg font-semibold text-gray-900">{result.fish_item}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500">Data Source</label>
                      <p className="text-lg font-semibold text-gray-900 capitalize">{result.data_source.replace('_', ' ')}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-900">{result.growth_rate_kg_per_day.toFixed(6)} kg/day</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500">Growth Method</label>
                      <p className="text-lg font-semibold text-gray-900 capitalize">{result.growth_calculation_method.replace('_', ' ')}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-500">Feeding Rate</label>
                      <p className="text-lg font-semibold text-gray-900">{result.feeding_rate_percent.toFixed(1)}%</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500">Feeding Frequency</label>
                      <p className="text-lg font-semibold text-gray-900">{result.feeding_frequency} times/day</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500">Pond Area</label>
                      <p className="text-lg font-semibold text-gray-900">{result.pond_area_decimal} decimal ({result.pond_area_sqm.toFixed(0)} sqm)</p>
                    </div>
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    <p className="text-lg font-semibold text-gray-900 flex items-center">
                      ...
                      {result.target_date ? new Date(result.target_date).toLocaleDateString() : 'N/A'}
                    </p>
                  </div>

                  <div className="border-t pt-4">
                    <label className="text-sm font-medium text-gray-500">Calculation Notes</label>
